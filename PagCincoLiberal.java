...
public class PagCincoLiberal extends JFrame implements  ActionListener, ChangeListener
{
	...
	public PagCincoLiberal()
	{
		setLayout(null);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
        setTitle("Cuestionario Liberal - Pregunta Cinco");
