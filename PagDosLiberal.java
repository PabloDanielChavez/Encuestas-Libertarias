...
public class PagDosLiberal extends JFrame implements  ActionListener, ChangeListener
{
	...
	public PagDosLiberal()
	{
		setLayout(null);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setTitle("Cuestionario Liberal - Pregunta Dos");
	...
	public static void main(String args[])
	{
		...
		pagdosliberal.setBounds(0,0,416,306);
