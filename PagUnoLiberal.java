...
public class PagUnoLiberal extends JFrame implements  ActionListener, ChangeListener
{
	...
	public PagUnoLiberal()
	{
		setLayout(null);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setTitle("Cuestionario Liberal - Pregunta Uno");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			PagDosLiberal pagdospiberal = new PagDosLiberal();
			pagdospiberal.setBounds(0,0,800,600);
			pagdospiberal.setVisible(true);
			pagdospiberal.setResizable(false);
			pagdospiberal.setLocationRelativeTo(null);
			this.setVisible(false);
			if(Check3.isSelected() == true && Check1.isSelected() == false  && Check2.isSelected() == false && Check3.isSelected() == false)
			{
				Contador1 = 1;
	...
	{
		PagUnoLiberal pagunopiberal = new PagUnoLiberal();
		pagunopiberal.setBounds(0,0,800,600);
		pagunopiberal.setVisible(true);
		pagunopiberal.setResizable(false);
		pagunopiberal.setLocationRelativeTo(null);
	}
}