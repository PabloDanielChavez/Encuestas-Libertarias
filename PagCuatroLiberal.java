...
public class PagCuatroLiberal extends JFrame implements  ActionListener, ChangeListener
{
	...
	public PagCuatroLiberal()
	{
		setLayout(null);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
        setTitle("Cuestionario Liberal - Pregunta Cuatro");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == BotonAtras)
		{
			...
			pagtresliberal.setBounds(0,0,800,600);
		...
		if(e.getSource() == BotonSiguiente)
		{
			...
			pagcincoliberal.setBounds(0,0,800,600);
			pagcincoliberal.setVisible(true);
			pagcincoliberal.setResizable(false);
			pagcincoliberal.setLocationRelativeTo(null);
			this.setVisible(false);
			if(Check3.isSelected() == true && Check1.isSelected() == false  && Check2.isSelected() == false && Check3.isSelected() == false)
			{
				Contador4 = 1;
